...
const BentoItem = ({ title, description, className, imgCard }: BentoItemProps) => {
  return (
    <div className={clsx("w-full p-4 rounded-xl border border-black/30 shadow-inner shadow-white/10 flex justify-end flex-col gap-y-4 relative overflow-hidden group text-white min-h-96 lg:min-h-0", className)}>
